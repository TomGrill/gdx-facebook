...
import de.kromzem.bindings.fb.sdk.share.fbsdksharekit.protocol.FBSDKSharingDelegate;
import de.kromzem.bindings.fb.sdk.share.fbsdksharekit.protocol.FBSDKSharingDialog;

@Generated
@Library("FBSDKShareKit")
@Runtime(ObjCRuntime.class)
@ObjCClassBinding
public class FBSDKMessageDialog extends NSObject implements FBSDKSharingDialog {
	static {
		NatJ.register();
	}

	@Generated
	protected FBSDKMessageDialog(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native FBSDKMessageDialog alloc();
	...
	@Generated
	@Selector("init")
	public native FBSDKMessageDialog init();
