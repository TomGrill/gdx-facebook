...
import de.kromzem.bindings.fb.sdk.share.fbsdksharekit.protocol.FBSDKSharingButton;

@Generated
@Library("FBSDKShareKit")
@Runtime(ObjCRuntime.class)
@ObjCClassBinding
public class FBSDKShareButton extends FBSDKButton implements FBSDKSharingButton {
	static {
		NatJ.register();
	}

	@Generated
	protected FBSDKShareButton(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native FBSDKShareButton alloc();
	...
	public static native FBSDKShareButton buttonWithType(@NInt long buttonType);
	...
	@Generated
	@Selector("init")
	public native FBSDKShareButton init();

	@Generated
	@Selector("initWithCoder:")
	public native FBSDKShareButton initWithCoder(NSCoder aDecoder);

	@Generated
	@Selector("initWithFrame:")
	public native FBSDKShareButton initWithFrame(@ByValue CGRect frame);
