...
@ObjCClassBinding
public class FBSDKSendButton extends FBSDKButton implements FBSDKSharingButton {
	static {
		NatJ.register();
	}

	@Generated
	protected FBSDKSendButton(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native FBSDKSendButton alloc();
	...
	public static native FBSDKSendButton buttonWithType(@NInt long buttonType);
	...
	@Generated
	@Selector("init")
	public native FBSDKSendButton init();

	@Generated
	@Selector("initWithCoder:")
	public native FBSDKSendButton initWithCoder(NSCoder aDecoder);
