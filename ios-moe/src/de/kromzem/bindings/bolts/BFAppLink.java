...
public class BFAppLink extends NSObject {
	...
	@Generated
	protected BFAppLink(Pointer peer) {
		super(peer);
	}
	...
	public static native BFAppLink appLinkWithSourceURLTargetsWebURL(
			NSURL sourceURL, NSArray<?> targets, NSURL webURL);
